...
function Incidents() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#E4E4E7] font-[primary]">
      {/* Header Section */}
      <header className="flex flex-col md:flex-row items-center justify-between md:mx-20 md:h-[41px]">
        {/* Logo */}
      ...
      <main className=" md:mx-20  py-4">
        <div className="flex flex-col md:flex-row justify-between items-center mb-6">
          <div className="mb-4 md:mb-0">
            <p className="text-[12px] text-[#71717A] font-[400] font-primary">Home - Incidents</p>
            <h1 className="text-[26px] text-[#09090B] font-[700]">Incidents</h1>
          </div>
          <div className="flex flex-col md:flex-row items-center space-x-0 md:space-x-4 space-y-2 md:space-y-0">
            ...
            <button className="bg-[#F26922] py-2 px-6 rounded-md hover:bg-orange-600 focus:outline-none focus:ring focus:border-orange-300 w-full md:w-[148px] h-[42px] text-[12px] text-[#FFFFFF] font-[700] flex items-center justify-center space-x-2">
              <span><FaPlus /></span>
      ...
      <div className='bg-[#FFFFFF] pt-10 md:px-20'>
        <Card />
      </div>
    </div>
